...
API_KEY = getenv("30DxNexGenBots225baa", None) # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SaumyaPatidaar/AviaxMusic",
)
